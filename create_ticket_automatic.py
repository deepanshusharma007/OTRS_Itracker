                                ...
                                <!DOCTYPE html>
                                    ...
                                    <table style="border: 1px solid black; border-collapse: collapse;">
                                      ...
                                      <tr>
                                        ...
                                        <td style="border: 1px solid black; padding: 5px;">No resolution</td>
                                      </tr>
                                    </table>
...
class CreateTicketAutomatic(Resource):
    @cross_origin()
    # @token_required
    def get(self):
        return {'hello': 'hi'}
    ...
    def post(self):
        ...
        try:
            ...
            print(data, "<-----------------")
            # {'severity': 'Low', 'data': [{'logs': ''}], 'description': 'Sample test', 'ticketType': 'Incident ticket',
            #  'title': 'I -Tracker Testing ', 'customerName': 'Protean E-gov'}
            # user_customer_id = jwtData['customerid']
            # print(user_customer_id)
            # user_id = jwtData['userid']

            user = User.query.filter_by(username="SIEMtool").first()
            print(user.email)

            customer_name = data.get('customerName')  # Assuming customer name is sent here
            ...
            print(type)
            if type == 'Incident ticket':
                type = 'IR'
            print('middle type', type)

            if type != 'IR':
                return jsonify({'messsage': 'Ticket type is not correct'}), 403
            ...
            print("Ticket created file paths-> ", new_ticket.file_paths)
